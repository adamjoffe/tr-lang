#ifndef EMPTY_TR_PROG_LIST_H
#define EMPTY_TR_PROG_LIST_H

namespace TR {

    /**
     * Empty TR Program List
     *
     * Empty list of high level program declarations
     */
    class EmptyTRProgList : public ASTList {
    public:

        /// Remove default constructor for this
        EmptyTRProgList() = delete;
         ...
         */
        EmptyTRProgList(const location& l, const std::string& f) : ASTList(l,f) {}
         ...
         */
        EmptyTRProgList(const location& l, const std::string& f, const std::string& src) : ASTList(l,f,src) {}
